...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.FourIL.AlarmApp", "alarm", ALARMS);
        sURLMatcher.addURI("com.FourIL.AlarmApp", "alarm/#", ALARMS_ID);
    }
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        if (ret == null) {
            if (true) Log.v("FourInLove", "Alarms.query: failed");
        } else {
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        Log.v("FourInLove", "*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        Log.v("FourInLove", "Added alarm rowId = " + rowId);
