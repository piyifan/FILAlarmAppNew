...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.FourIL.AlarmApp.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.FourIL.AlarmApp.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.FourIL.AlarmApp.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.FourIL.AlarmApp.ALARM_DISMISS";
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    if (a.time == 0) {
                        ...
                        Log.v("FourInLove", "Disabling expired alarm set for ");
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        if (true) {
            Log.v("FourInLove", "** setAlert id " + alarm.id + " atTime " + atTimeInMillis);
        }
