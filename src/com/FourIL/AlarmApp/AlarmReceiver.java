...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (alarm == null) {
            Log.v("FourInLove", "Failed to parse the alarm from the intent");
        ...
        if (now > alarm.time + STALE_WINDOW) {
            Log.v("FourInLove", "Ignoring stale alarm");
            return;
        }
    ...
    private void updateNotification(Context context, Alarm alarm, int timeout) {
        ...
        if (alarm == null) {
            if (true) {
                Log.v("FourInLove", "Cannot update notification for killer callback");
            }
            return;
        }
